...
const LeadSchema = new mongoose.Schema({
  ...
  leadType: { type: String, enum: ['Hot Lead', 'Mid Lead', 'Cold Lead'], default: 'Cold Lead', index: true },
  pipelineStatus: { type: String, enum: LEAD_PIPELINE, default: 'New Lead', index: true },
  callStatus: {
    type: String,
